        ...
        <div class="order-summary-bar">
            <div>
                ...
                <p class="muted" style="margin: 0.1rem 0 0; font-size: 0.88rem;">
                    <?php if($order->order_type === 'custom_cake'): ?>
                        Custom Cake — Pickup <?php echo e($order->pickup_time?->format('d M Y')); ?>

                    <?php else: ?>
                        Pre-order — Pickup <?php echo e($order->pickup_time?->format('d M Y, H:i')); ?>
            ...
            <div style="text-align: right;">
                ...
                <strong style="font-size: 1.15rem; color: var(--accent-deep);">
                    Rp <?php echo e(number_format((float) $order->total_amount, 0, ',', '.')); ?>
    ...
    <div class="card stack">
        ...
        <div class="panel-section visible" id="panel-va">
            ...
            <div class="info-box">
                ...
                <div class="account-number"><?php echo e($virtualAccount); ?></div>
                <div class="amount-label">Amount to Pay</div>
                <div class="amount">Rp <?php echo e(number_format((float) $order->total_amount, 0, ',', '.')); ?></div>
        ...
        <div class="panel-section" id="panel-bank">
            ...
            <?php if($bankName && $bankAccountNumber): ?>
                <div class="info-box">
                    <div style="font-size: 0.8rem; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: #897667; margin-bottom: 0.4rem;">
                        Bank <?php echo e(strtoupper($bankName)); ?>

                    </div>
                    <div class="account-number"><?php echo e($bankAccountNumber); ?></div>
                    <div style="font-weight: 600; color: var(--text); margin-bottom: 1rem;">a/n <?php echo e($bankAccountName); ?></div>
                    <div class="amount-label">Amount to Pay</div>
                    <div class="amount">Rp <?php echo e(number_format((float) $order->total_amount, 0, ',', '.')); ?></div>
        ...
        <form action="<?php echo e(route('menu.payment.process', ['bakery' => $bakery->public_slug, 'order' => $order->order_number])); ?>" method="POST" id="pay-form">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Wilson Tjokro\Downloads\bakery-webapp\resources\views/public/payment.blade.php ENDPATH**/ ?>